...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    private let demos = ["Areas & Shapes", "Building & Floor Selection", "Camera", "Colors & Textures", "Display a Map", "Image3D", "Interactivity", "Labels", "Locations", "Markers", "Models", "Multi-Floor View", "Navigation", "Paths", "Query", "Search", "Stacked Maps", "Turn by Turn"]
